...
def main():
    ...
    parser.add_argument("--index_path", default=os.path.join(_PROJECT_ROOT, "data", "labels", "games_index.csv"))
    ...
    parser.add_argument("--output", default=os.path.join(_PROJECT_ROOT, "data", "labels", "labels_all.csv"))
